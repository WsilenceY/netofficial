            ...
            {/* part 2 */}
                <div className="mx-auto w-full lg:h-screen sm:h-hpart2 bg-cover relative">
                    <div className='lg:h-1/2 sm:h-auto lg:absolute sm:relative lg:top-0 sm:top-4 bottom-0 m-auto w-auto  lg:px-28 sm:px-mspace z-9'>
                        ...
                        <Image className='mb-8' src='/images/part3img1.png'></Image>
                            <div className="flex lg:flex-row  sm:flex-col gap-8 z-9">
                                <p>
                                    ...
                                    <ul className='flex justify-around mt-12'>
                                        <li>
                                            <Image className='w-8' src='/images/icon1.png'></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src='/images/icon2.png'></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src='/images/icon3.png'></Image>
                                        </li>
                                    </ul>
                                </p>
                                <p>
                                    ...
                                    <ul className='flex justify-around mt-12'>
                                        <li>
                                            <Image className='w-8' src='/images/icon4.png'></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src='/images/icon5.png'></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src='/images/icon6.png'></Image>
                                        </li>
                                    </ul>
                                </p>
                            </div>
