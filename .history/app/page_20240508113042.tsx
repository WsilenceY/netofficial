        ...
        <main className="bg-block h-fit w-full flex-1 absolute top-0 box-border bg-[#100F22] relative selector">
            ...
            {/* part 2 */}
                ...
                <div className="mx-auto w-full lg:h-screen sm:h-hpart4  bg-cover relative">
                    <Image className="absolute top-0 left-0 right-0 m-auto" style={{width: '35rem'}} src={part5_2img.src} alt=""/>
                    <div className='h-4/5 absolute top-0 bottom-0 m-auto w-auto  lg:px-28 sm:px-mspace'>
                            <Image className="mx-auto mb-10 lg:mt-24" src={part5img.src} alt=""/>
                ...
                <div className="mx-auto w-full lg:h-screen sm:h-hpart5 bg-cover relative ">
                    <div className='flex lg:flex-row sm:flex-col items-center justify-around lg:px-28 sm:px-mspace'>
                        ...
                        <div className='lg:w-120'>
                            ...
                            <p className="text-base text-justify mb-8">Users can not only enjoy entertainment by watching video content but also earn platform tokens in real-time through the "watch-to-earn” feature, integrating entertainment with economic benefits.</p>
                            <h3 className="lg:text-3xl sm:2xl mb-2.5">{intl.get('PART5H2')}</h3>
                            <p className="text-base text-justify">NetReel also targets creative users whose ideas can be utilized on the platform, allowing creations to be converted into NFTs, thus digitizing and globalizing real-world investment opportunities.</p>
                        </div>
                    </div>
