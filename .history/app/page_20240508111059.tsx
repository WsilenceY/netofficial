            ...
            {/* part 2 */}
                <div className="mx-auto w-full lg:h-screen sm:h-hpart2 bg-cover relative">
                    <div className='lg:h-1/2 sm:h-auto lg:absolute sm:relative lg:top-0 sm:top-4 bottom-0 m-auto w-auto  lg:px-28 sm:px-mspace z-9'>
                        ...
                        <Image className='mb-8' src='/public/part3img1.png'></Image>
                            <div className="flex lg:flex-row  sm:flex-col gap-8 z-9">
                                <p>
                                    ...
                                    <ul className='flex justify-around mt-12'>
                                        <li>
                                            <Image className='w-8' src={icon1.src}></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src={icon2.src}></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src={icon3.src}></Image>
                                        </li>
                                    </ul>
                                </p>
                                <p>
                                    ...
                                    <ul className='flex justify-around mt-12'>
                                        <li>
                                            <Image className='w-8' src={icon4.src}></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src={icon5.src}></Image>
                                        </li>
                                        <li>
                                            <Image className='w-8' src={icon6.src}></Image>
                                        </li>
                                    </ul>
                                </p>
                            </div>
                        <Image className='mt-8'  src={part3img2.src}></Image>
                    </div>
                    <Image className="absolute right-0 top-96 z-0"  src={rightimg.src} alt=""/>
                </div>
        </main>
     }
    </>
